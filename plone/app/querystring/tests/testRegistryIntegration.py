...
from plone.app.querystring.tests.base import QuerystringTestCase, TestProfileLayer, ptc
...
class TestOperationDefinitions(ptc.PloneTestCase):
    ...
    def test_string_equality(self):
        ...
        self.assertEqual(registry[prefix+".operation"], 'plone.app.querystring.queryparser:_equal')
    ...
    def test_date_lessthan(self):
        ...
        self.assertEqual(registry[prefix+".operation"], 'plone.app.querystring.queryparser:_lessThan')
